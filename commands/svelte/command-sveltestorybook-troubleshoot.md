---
id: command-sveltestorybook-troubleshoot
type: command
name: /svelte:storybook-troubleshoot
description: Diagnose and fix common Storybook issues in SvelteKit projects, including
  build errors, module problems, and configuration issues....
category: svelte
complexity: medium
keywords:
- javascript
...
**Reference this template:** `@command-sveltestorybook-troubleshoot.md`
