---
id: command-documentation-update-synchronization
type: command
name: Documentation Update & Synchronization
description: '---

  allowed-tools: Read, Write, Edit, Bash

  argument-hint: [doc-type] | --implementation | --api | --architecture | --sync |
  --validate

  description: Systematically update project documentation with imp...'
...
**Reference this template:** `@command-documentation-update-synchronization.md`
