---
id: command-developer-onboarding-guide-generator
type: command
name: Developer Onboarding Guide Generator
description: '---

  allowed-tools: Read, Write, Edit, Bash

  argument-hint: [role-type] | --developer | --designer | --devops | --comprehensive
  | --interactive

  description: Create comprehensive developer onboarding gui...'
...
- Development capabilities: File operations, code editing, terminal access, search!`find . -name ".env*" -o -name "docker-compose.yml" -o -name "Makefile" | head -3`
...
**Reference this template:** `@command-developer-onboarding-guide-generator.md`
