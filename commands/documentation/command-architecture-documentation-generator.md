---
id: command-architecture-documentation-generator
type: command
...
description: '---
  ...
  description: Generate comprehensive architecture documentation with d...'
...
**Reference this template:** `@command-architecture-documentation-generator.md`
