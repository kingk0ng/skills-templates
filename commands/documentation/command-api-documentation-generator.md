---
id: command-api-documentation-generator
type: command
...
description: '---
  ...
  description: Generate comprehensive API documentation from code with inte...'
...
**Reference this template:** `@command-api-documentation-generator.md`
