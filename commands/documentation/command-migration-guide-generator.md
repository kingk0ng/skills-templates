---
id: command-migration-guide-generator
type: command
...
description: '---
  ...
  argument-hint: [migration-type] | framework | database | cloud | architecture |
  --version-upgrade

  description: Create comprehensive migration guides with ste...'
...
**Reference this template:** `@command-migration-guide-generator.md`
