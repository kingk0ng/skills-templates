---
id: command-automated-api-documentation-generator
type: command
...
description: '---
  ...
  argument-hint: [output-format] | --swagger-ui | --redoc | --postman | --insomnia
  | --multi-format

  description: Auto-generate API reference documentation with...'
...
- Documentation capabilities: File operations, code editing, terminal access, search!`grep -E "swagger|redoc|postman" package.json 2>/dev/null || echo "None detected"`
...
**Reference this template:** `@command-automated-api-documentation-generator.md`
