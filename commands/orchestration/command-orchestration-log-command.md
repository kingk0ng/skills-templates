---
id: command-orchestration-log-command
type: command
name: Orchestration Log Command
description: Log work from orchestrated tasks to external project management tools
  like Linear, Obsidian, Jira, or GitHub Issues....
...
**Reference this template:** `@command-orchestration-log-command.md`
