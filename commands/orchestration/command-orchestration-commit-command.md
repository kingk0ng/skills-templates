---
id: command-orchestration-commit-command
type: command
name: Orchestration Commit Command
description: Create git commits aligned with task completion, maintaining clean version
  control synchronized with task progress....
...
**Reference this template:** `@command-orchestration-commit-command.md`
