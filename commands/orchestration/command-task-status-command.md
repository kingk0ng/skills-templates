---
id: command-task-status-command
type: command
name: Task Status Command
description: Check the current status of tasks in the orchestration system with various
...
**Reference this template:** `@command-task-status-command.md`
