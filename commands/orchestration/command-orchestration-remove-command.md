---
id: command-orchestration-remove-command
type: command
name: Orchestration Remove Command
description: Safely remove a task from the orchestration system, updating all references
  and dependencies....
...
**Reference this template:** `@command-orchestration-remove-command.md`
