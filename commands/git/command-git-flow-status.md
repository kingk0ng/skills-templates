...
description: '---
  ...
  description: Display comprehensive Git Flow status including branch type, sync status,
  changes, and merge targets
...
**Reference this template:** `@command-git-flow-status.md`
