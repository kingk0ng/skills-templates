---
id: command-git-flow-release-branch
type: command
name: Git Flow Release Branch
description: '---
  ...
  description: Create a new Git Flow release branch from develop with version bumping
...
---
allowed-capabilities: File operations, code editing, terminal access, search(git:*), Read, Edit, Write
argument-hint: <version>
description: Create a new Git Flow release branch from develop with version bumping and changelog generation
---
...
**Reference this template:** `@command-git-flow-release-branch.md`
