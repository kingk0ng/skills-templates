---
id: command-git-flow-hotfix-branch
type: command
name: Git Flow Hotfix Branch
description: '---
  ...
  description: Create a new Git Flow hotfix branch from main for emergency production
  fixes
...
**Reference this template:** `@command-git-flow-hotfix-branch.md`
