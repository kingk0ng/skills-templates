---
id: command-google-workspace-modelarmor-create-template
type: command
name: Google Workspace Modelarmor Create Template
description: '---
...
**Reference this template:** `@command-google-workspace-modelarmor-create-template.md`
