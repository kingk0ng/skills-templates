---
id: command-google-workspace-workflow-file-announce
type: command
name: Google Workspace Workflow File Announce
description: '---
...
**Reference this template:** `@command-google-workspace-workflow-file-announce.md`
