---
id: command-google-workspace-modelarmor-sanitize-response
type: command
name: Google Workspace Modelarmor Sanitize Response
description: '---
...
**Reference this template:** `@command-google-workspace-modelarmor-sanitize-response.md`
