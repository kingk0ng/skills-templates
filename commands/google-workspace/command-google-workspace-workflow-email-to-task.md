---
id: command-google-workspace-workflow-email-to-task
type: command
name: Google Workspace Workflow Email To Task
description: '---
...
**Reference this template:** `@command-google-workspace-workflow-email-to-task.md`
