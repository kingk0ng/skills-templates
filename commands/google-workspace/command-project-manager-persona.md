---
id: command-project-manager-persona
type: command
name: Project Manager Persona
description: '---
...
Operate as Project Manager using Google Workspace capabilities: File operations, code editing, terminal access, search$ARGUMENTS
...
**Reference this template:** `@command-project-manager-persona.md`
