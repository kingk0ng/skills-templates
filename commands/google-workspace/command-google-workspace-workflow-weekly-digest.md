---
id: command-google-workspace-workflow-weekly-digest
type: command
name: Google Workspace Workflow Weekly Digest
description: '---
...
**Reference this template:** `@command-google-workspace-workflow-weekly-digest.md`
