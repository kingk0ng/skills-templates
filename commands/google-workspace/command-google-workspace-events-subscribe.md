---
id: command-google-workspace-events-subscribe
type: command
name: Google Workspace Events Subscribe
description: '---
...
**Reference this template:** `@command-google-workspace-events-subscribe.md`
