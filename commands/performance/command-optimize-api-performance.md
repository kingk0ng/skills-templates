---
id: command-optimize-api-performance
type: command
...
description: '---
  ...
  description: Comprehensive API performance optimization with response time reduction,
  throughput impro...'
...
allowed-tools: Read, Bash, Grep, Glob
argument-hint: [api-type] | --rest | --graphql | --grpc
description: Comprehensive API performance optimization with response time reduction, throughput impro...
...
**Reference this template:** `@command-optimize-api-performance.md`
