---
id: command-optimize-bundle-size
type: command
...
description: '---
  ...
  description: Reduce and optimize bundle sizes through analysis, configuration, and
  code splitting ...'
...
allowed-tools: Read, Bash, Grep, Glob
argument-hint: [build-tool] | --webpack | --vite | --rollup
description: Reduce and optimize bundle sizes through analysis, configuration, and code splitting ...
...
**Reference this template:** `@command-optimize-bundle-size.md`
