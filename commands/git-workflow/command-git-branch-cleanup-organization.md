---
id: command-git-branch-cleanup-organization
type: command
name: Git Branch Cleanup & Organization
description: '---

  allowed-tools: Bash(git branch:*), Bash(git checkout:*), Bash(git push:*), Bash(git
  merge:*), Bash(gh:*), Read, Grep
...
---
allowed-capabilities: File operations, code editing, terminal access, search(git branch:*), Bash(git checkout:*), Bash(git push:*), Bash(git merge:*), Bash(gh:*), Read, Grep
argument-hint: [--dry-run] | [--force] | [--remote-only] | [--local-only]
...
**Reference this template:** `@command-git-branch-cleanup-organization.md`
