---
id: command-gemini-pr-review-automation
type: command
name: Gemini PR Review Automation
description: '---
  ...
  description: Transform Gemini Code Assist PR ...'
...
---
allowed-capabilities: File operations, code editing, terminal access, search(gh:*), Read, Grep, TodoWrite, Edit, MultiEdit
argument-hint: [pr-number] | --analyze-only | --preview | --priority high|medium|low
...
**Reference this template:** `@command-gemini-pr-review-automation.md`
