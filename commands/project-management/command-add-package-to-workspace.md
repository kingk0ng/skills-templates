---
id: command-add-package-to-workspace
type: command
...
description: '---
  ...
  description: Add and configure new package to workspace with proper s...'
...
**Reference this template:** `@command-add-package-to-workspace.md`
