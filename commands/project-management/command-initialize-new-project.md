---
id: command-initialize-new-project
type: command
...
description: '---
  ...
  description: Initialize new project with essential structure, configuration...'
...
**Reference this template:** `@command-initialize-new-project.md`
