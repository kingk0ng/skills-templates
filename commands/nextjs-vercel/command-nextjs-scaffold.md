...
description: '---
  ...
  description: Create a new Next.js application with best practices and optimal config...'
...
**Reference this template:** `@command-nextjs-scaffold.md`
