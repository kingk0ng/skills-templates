---
id: command-nextjs-middleware-creator
type: command
...
description: '---
  ...
  description: Create optimized Next.js middleware with authentication, rate limiti...'
...
**Reference this template:** `@command-nextjs-middleware-creator.md`
