---
id: command-create-app-directory-structure
type: command
...
description: '---
  ...
  description: Comprehensive Next.js migration assistant for Pages Rout...'
...
**Reference this template:** `@command-create-app-directory-structure.md`
