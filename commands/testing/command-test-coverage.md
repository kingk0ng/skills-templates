...
description: '---
  ...
  argument-hint: [coverage-type] | --line | --branch | --function | --statement |
  --report

  description: Analyze and improve test coverage with comprehensive re...'
category: testing
complexity: medium
keywords:
- performance
...
- Coverage capabilities: File operations, code editing, terminal access, search!`npm ls nyc jest @jest/core 2>/dev/null | grep -E "nyc|jest" | head -2 || echo "No JS coverage tools"`
...
**Reference this template:** `@command-test-coverage.md`
