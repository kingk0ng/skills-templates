---
id: command-game-analytics-player-intelligence-system
type: command
name: Game Analytics & Player Intelligence System
description: '---

  allowed-tools: Read, Write, Edit, Bash

  argument-hint: [analytics-type] | --player-behavior | --performance | --monetization
  | --retention | --comprehensive

  description: Use PROACTIVELY to implemen...'
...
**Reference this template:** `@command-game-analytics-player-intelligence-system.md`
