---
id: command-blue-green-deployment-strategy
type: command
...
description: '---
  ...
  description: Implement blue-green deployment strategy with zero-downtime switching,
  h...'
category: deployment
complexity: medium
keywords:
...
allowed-tools: Read, Write, Edit, Bash
argument-hint: [strategy] | setup | deploy | switch | rollback | status
description: Implement blue-green deployment strategy with zero-downtime switching, h...
...
**Reference this template:** `@command-blue-green-deployment-strategy.md`
