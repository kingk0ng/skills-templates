---
id: command-emergency-hotfix-deployment
type: command
...
description: '---
  ...
  description: Deploy critical hotfixes with emergency procedures, validation,...'
category: deployment
complexity: medium
keywords:
- api
...
**Reference this template:** `@command-emergency-hotfix-deployment.md`
