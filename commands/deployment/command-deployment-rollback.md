---
id: command-deployment-rollback
type: command
...
description: '---
  ...
  argument-hint: [target-version] | --previous | --emergency | --validate-first |
  --with-db

  description: Rollback deployment to previous version with safety checks, d...'
category: deployment
complexity: medium
keywords:
- api
...
**Reference this template:** `@command-deployment-rollback.md`
