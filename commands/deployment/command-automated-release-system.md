---
id: command-automated-release-system
type: command
...
description: '---
  ...
  argument-hint: [release-type] | --semantic | --conventional-commits | --github-actions
  | --full-automation

  description: Setup automated release workflows wit...'
category: deployment
complexity: medium
keywords:
- api
...
**Reference this template:** `@command-automated-release-system.md`
