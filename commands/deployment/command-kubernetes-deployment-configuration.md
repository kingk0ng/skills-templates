---
id: command-kubernetes-deployment-configuration
type: command
...
description: '---
  ...
  argument-hint: [deployment-type] | --microservices | --monolith | --stateful | --full-stack
  | --production-ready

  description: Configure comprehensive Kuberne...'
category: deployment
complexity: medium
keywords:
- ci/cd
...
**Reference this template:** `@command-kubernetes-deployment-configuration.md`
