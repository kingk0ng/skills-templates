---
id: command-deployment-monitoring-observability
type: command
...
description: '---
  ...
  argument-hint: [monitoring-type] | setup | dashboard | alerts | metrics | health
  | performance

  description: Comprehensive deployment monitoring with observab...'
category: deployment
complexity: medium
keywords:
- api
...
**Reference this template:** `@command-deployment-monitoring-observability.md`
