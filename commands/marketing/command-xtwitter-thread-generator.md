---
id: command-xtwitter-thread-generator
type: command
...
description: '---
  ...
  description: Generate copy-pastable X/Twitter threads from blog posts, articles,
  PDFs, or URLs with 3 format options
...
**Reference this template:** `@command-xtwitter-thread-generator.md`
