...
description: '---
  ...
  description: Plan and organize sprint workflows with Linear integration and capacity
  analysis
...
**Reference this template:** `@command-sprint-planning.md`
