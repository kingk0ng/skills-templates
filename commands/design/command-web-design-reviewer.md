---
id: command-web-design-reviewer
type: command
...
description: '---
  ...
  description: This skill enables visual inspection of websites running locally or
...
> ---
allowed-tools: Bash, Read
description: This skill enables visual inspection of websites running locally or remotely to identify and fix design issues. Triggers on requests like "review website des...
...
**Reference this template:** `@command-web-design-reviewer.md`
