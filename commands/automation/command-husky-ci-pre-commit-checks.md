---
id: command-husky-ci-pre-commit-checks
type: command
name: Husky CI Pre-commit Checks
description: '---
  ...
  description: Run comprehensive CI checks and fix issues until repository is in working
  state
...
**Reference this template:** `@command-husky-ci-pre-commit-checks.md`
