---
id: command-sync-status-monitor
type: command
...
description: '---
  ...
  description: Monitor GitHub-Linear sync health status with performance metrics and
  diagnostics
...
**Reference this template:** `@command-sync-status-monitor.md`
