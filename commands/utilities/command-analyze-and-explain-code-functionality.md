---
id: command-analyze-and-explain-code-functionality
type: command
name: Analyze and Explain Code Functionality
...
**Reference this template:** `@command-analyze-and-explain-code-functionality.md`
