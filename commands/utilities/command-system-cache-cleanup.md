---
id: command-system-cache-cleanup
type: command
name: System Cache Cleanup
description: '---

  allowed-tools: Bash(df:*), Bash(du:*), Bash(npm cache clean:*), Bash(brew cleanup:*),
  Bash(rm:*), Bash(find:*), Bash(docker system prune:*)
...
---
allowed-capabilities: File operations, code editing, terminal access, search(df:*), Bash(du:*), Bash(npm cache clean:*), Bash(brew cleanup:*), Bash(rm:*), Bash(find:*), Bash(docker system prune:*)
argument-hint: [--aggressive] | [--maximum]
...
**Reference this template:** `@command-system-cache-cleanup.md`
