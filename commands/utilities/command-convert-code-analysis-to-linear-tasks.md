---
id: command-convert-code-analysis-to-linear-tasks
type: command
name: Convert Code Analysis to Linear Tasks
description: This command scans your codebase for TODO/FIXME comments, technical debt
  markers, deprecated code, and other indicators that should be tracked as tasks.
  It automatically creates organized, prioritized Linear tasks to ensure important
  code improvements aren't forgotten.
category: utilities
complexity: medium
keywords:
- api
...
**Reference this template:** `@command-convert-code-analysis-to-linear-tasks.md`
