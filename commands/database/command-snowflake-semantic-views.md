---
id: command-snowflake-semantic-views
type: command
...
description: '---
  ...
  description: Create, alter, and validate Snowflake semantic views using Snowflake
...
> ---
allowed-tools: Bash, Read
description: Create, alter, and validate Snowflake semantic views using Snowflake CLI (snow). Use when asked to build or troubleshoot semantic views/semantic layer defini...
...
**Reference this template:** `@command-snowflake-semantic-views.md`
