---
id: skill-isms-audit-expert
type: skill
name: isms-audit-expert
description: Senior ISMS Audit Expert for internal and external information security
  management system auditing. Provides ISO 27001 audit expertise, security audit program
  management, security control assessment, and compliance verification. Use for ISMS
  internal auditing, external audit preparation, security control testing, and ISO
  27001 certification support.
...
# Reference Documentation for Isms Audit Expert
...
**Reference this template:** `@skill-isms-audit-expert.md`
