...
3. **Add tools:**
   ...
   - Common capabilities: File operations, code editing, terminal access, searchRun Zap, Add Row to Google Sheets, Send Email, etc.
...
Claude:
1. [MCP capabilities: File operations, code editing, terminal access, searchaction with parameters]
   → [Expected result]
2. [Process the result]
3. [Next MCP capabilities: File operations, code editing, terminal access, searchaction]
   → [Expected result]
...
**Reference this template:** `@skill-zapier-workflows.md`
