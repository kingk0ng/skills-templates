---
id: skill-database-schema-designer
type: skill
name: database-schema-designer
description: Design robust, scalable database schemas for SQL and NoSQL databases.
  Provides normalization guidelines, indexing strategies, migration patterns, constraint
  design, and performance optimization. Ensures data integrity, query performance,
...
**Reference this template:** `@skill-database-schema-designer.md`
