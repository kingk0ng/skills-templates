---
id: skill-feature-design-assistant
type: skill
name: feature-design-assistant
description: Turn ideas into fully formed designs and specs through natural collaborative
  dialogue. Use when planning new features, designing architecture, or making significant
...
**Reference this template:** `@skill-feature-design-assistant.md`
