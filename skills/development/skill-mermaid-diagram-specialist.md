---
id: skill-mermaid-diagram-specialist
type: skill
name: mermaid-diagram-specialist
description: Mermaid diagram specialist for creating flowcharts, sequence diagrams,
  ERDs, and architecture visualizations
...
**Reference this template:** `@skill-mermaid-diagram-specialist.md`
