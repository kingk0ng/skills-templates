---
id: skill-web-to-markdown
type: skill
name: web-to-markdown
description: 'Use ONLY when the user explicitly says: ''use the skill web-to-markdown
  ...'' (or ''use a skill web-to-markdown ...''). Converts webpage URLs to clean Markdown
  by calling the local web2md CLI (Puppeteer + Readability), suitable for JS-rendered
  pages.'
...
**Reference this template:** `@skill-web-to-markdown.md`
