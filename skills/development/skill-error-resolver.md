---
id: skill-error-resolver
type: skill
name: Error Resolver
description: Systematic error diagnosis and resolution using first-principle analysis.
  Use when encountering any error message, stack trace, or unexpected behavior. Supports
  replay functionality to record and reuse solutions.
...
**Reference this template:** `@skill-error-resolver.md`
