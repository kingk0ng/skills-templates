---
id: skill-playwright-e2e-builder
type: skill
name: playwright-e2e-builder
description: Plan and build comprehensive Playwright E2E test suites with Page Object
  Model, authentication state persistence, custom fixtures, visual regression, and
  CI integration. Uses interview-driven planning to clarify critical user flows, auth
  strategy, test data approach, and parallelization before writing any tests.
...
**Reference this template:** `@skill-playwright-e2e-builder.md`
