...
- capabilities: File operations, code editing, terminal access, search`nest generate module`, `nest generate service`
...
- capabilities: File operations, code editing, terminal access, search`nest generate controller`, class-validator, class-transformer
...
- capabilities: File operations, code editing, terminal access, search`@nestjs/testing`, Jest, Supertest
...
- capabilities: File operations, code editing, terminal access, search`@nestjs/passport`, `@nestjs/jwt`, passport strategies
...
- capabilities: File operations, code editing, terminal access, search`@nestjs/config`, Joi validation
...
- capabilities: File operations, code editing, terminal access, searchBuilt-in Logger, custom exception filters
...
**Reference this template:** `@skill-nestjs-expert.md`
