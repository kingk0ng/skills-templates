...
// webpack.config.js
module.exports = {
  devcapabilities: File operations, code editing, terminal access, search'source-map', // Exposes source code
};

// ✅ Hidden source maps (uploaded to error tracker)
module.exports = {
  devcapabilities: File operations, code editing, terminal access, search'hidden-source-map',
};

// ✅ Or no source maps in production
module.exports = {
  devcapabilities: File operations, code editing, terminal access, searchprocess.env.NODE_ENV === 'production' ? false : 'source-map',
};
```
...
**Reference this template:** `@skill-best-practices.md`
