---
id: skill-devops-iac-engineer
type: skill
name: devops-iac-engineer
description: Implements infrastructure as code using Terraform, Kubernetes, and cloud
  platforms. Designs scalable architectures, CI/CD pipelines, and observability solutions.
  Provides security-first DevOps practices and site reliability engineering guidance.
...
**Reference this template:** `@skill-devops-iac-engineer.md`
