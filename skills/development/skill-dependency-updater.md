---
id: skill-dependency-updater
type: skill
name: dependency-updater
description: Smart dependency management for any language. Auto-detects project type,
  applies safe updates automatically, prompts for major versions, diagnoses and fixes
  dependency issues.
...
**Reference this template:** `@skill-dependency-updater.md`
