---
id: skill-move-code-quality
type: skill
name: move-code-quality
description: Analyzes Move language packages against the official Move Book Code Quality
  Checklist. Use this skill when reviewing Move code, checking Move 2024 Edition compliance,
  or analyzing Move packages for best practices. Activates automatically when working
  with .move files or Move.toml manifests.
...
- Recommend formatter capabilities: File operations, code editing, terminal access, searchCLI (npm), CI/CD integration, VSCode/Cursor plugin
...
**Reference this template:** `@skill-move-code-quality.md`
