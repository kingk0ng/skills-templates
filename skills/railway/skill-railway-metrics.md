---
id: skill-railway-metrics
type: skill
name: railway-metrics
description: Query resource usage metrics for Railway services. Use when user asks
  about resource usage, CPU, memory, network, disk, or service performance like "how
  much memory is my service using" or "is my service slow".
category: railway
complexity: medium
keywords:
- api
...
**Reference this template:** `@skill-railway-metrics.md`
