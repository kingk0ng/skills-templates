---
id: skill-railway-deploy
type: skill
name: railway-deploy
description: Deploy code to Railway using "railway up". Use when user wants to push
  code, says "railway up", "deploy", "ship", or "push". For initial setup or creating
  services, use railway-new skill. For Docker images, use railway-environment skill.
category: railway
complexity: medium
keywords:
- deploy
...
**Reference this template:** `@skill-railway-deploy.md`
