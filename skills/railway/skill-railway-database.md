---
id: skill-railway-database
type: skill
name: railway-database
description: Add official Railway database services (Postgres, Redis, MySQL, MongoDB).
  Use when user wants to add a database, says "add postgres", "add redis", "add database",
  "connect to database", or "wire up the database". For other templates (Ghost, Strapi,
  n8n), use the railway-templates skill.
category: railway
complexity: medium
keywords:
- api
...
**Reference this template:** `@skill-railway-database.md`
