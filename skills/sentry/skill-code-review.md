...
type: skill
name: code-review
description: Perform code reviews following Sentry engineering practices. Use when
  reviewing pull requests, examining code changes, or providing feedback on code quality.
  Covers security, performance, testing, and design review.
category: sentry
complexity: medium
keywords:
- api
...
**Reference this template:** `@skill-code-review.md`
