---
id: skill-zarr-python
type: skill
name: zarr-python
description: Chunked N-D arrays for cloud storage. Compressed arrays, parallel I/O,
  S3/GCS integration, NumPy/Dask/Xarray compatible, for large-scale scientific computing
  pipelines.
category: scientific
complexity: medium
keywords:
...
**Reference this template:** `@skill-zarr-python.md`
