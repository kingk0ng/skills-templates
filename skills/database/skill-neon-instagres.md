---
id: skill-neon-instagres
type: skill
name: neon-instagres
description: Instantly provision production-ready Postgres databases with Neon Instagres.
  Use when setting up databases, when users mention PostgreSQL/Postgres, database
  setup, or need a development database. Works with Drizzle, Prisma, raw SQL.
category: database
complexity: medium
keywords:
- database
...
**Reference this template:** `@skill-neon-instagres.md`
