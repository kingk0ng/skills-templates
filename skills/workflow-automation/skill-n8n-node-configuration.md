---
id: skill-n8n-node-configuration
type: skill
...
description: Operation-aware node configuration guidance. Use when configuring nodes,
  ...
  get_node_essentials and get_node_info, or learning common configuration patterns
  by node type.
...
**Reference this template:** `@skill-n8n-node-configuration.md`
