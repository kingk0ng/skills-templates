---
id: skill-pocketbase-collections
type: skill
name: PocketBase Collections
description: Collection and schema design for PocketBase. Use when creating collections,
  designing schemas, adding fields, setting up relations, or choosing between base/auth/view
  collection types. Prevents wrong field types, documents zero-default behavior, and
  covers relation cascading.
category: pocketbase
complexity: medium
keywords:
- api
...
**Reference this template:** `@skill-pocketbase-collections.md`
