---
id: skill-pocketbase-migrations
type: skill
name: PocketBase Migrations
description: Schema migrations and versioning for PocketBase. Use when creating migrations,
  managing schema versions, syncing collections between environments, using automigrate,
  or creating collections programmatically. Covers migrate commands, migration file
  format, snapshot imports, and the _migrations tracking table.
category: pocketbase
complexity: medium
keywords:
- api
...
**Reference this template:** `@skill-pocketbase-migrations.md`
