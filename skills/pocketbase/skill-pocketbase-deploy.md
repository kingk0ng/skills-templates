---
id: skill-pocketbase-deploy
type: skill
name: PocketBase Deploy
description: Production deployment for PocketBase. Use when deploying PocketBase to
  a server, setting up Docker, configuring systemd, reverse proxy (nginx/Caddy), TLS,
  SMTP, backups, S3 storage, rate limiting, or hardening for production. Provides
...
**Reference this template:** `@skill-pocketbase-deploy.md`
