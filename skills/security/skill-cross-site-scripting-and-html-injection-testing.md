---
id: skill-cross-site-scripting-and-html-injection-testing
type: skill
...
**Reference this template:** `@skill-cross-site-scripting-and-html-injection-testing.md`
