...
- capabilities: File operations, code editing, terminal access, searchMimikatz, PowerView, PowerUpSQL, Responder, Impacket, Rubeus
...
**Reference this template:** `@skill-privilege-escalation-methods.md`
