...
type: skill
name: data-feeds
description: Extract structured data from 40+ websites including Amazon, LinkedIn,
  Instagram, TikTok, Facebook, YouTube, and more. Uses Bright Data's Web Data APIs
  with automatic polling. Returns clean JSON with product details, profiles, reviews,
  posts, and comments.
category: web-data
complexity: medium
keywords:
...
**Reference this template:** `@skill-data-feeds.md`
