---
id: skill-autonomous-agent-patterns
type: skill
...
class MCPAgent:
    ...
    async def create_tool(self, description: str) -> str:
        ...
        return f"Created capabilities: File operations, code editing, terminal access, search{server_name}"
```
...
**Reference this template:** `@skill-autonomous-agent-patterns.md`
