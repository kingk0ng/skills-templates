...
description: Provides guidance for training LLMs with reinforcement learning using
  ...
  for LLM post-training at scale with flexible infrastructure backends.
...
**Reference this template:** `@skill-verl-rl-training.md`
