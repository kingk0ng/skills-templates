...
class ReActAgent:
    def __init__(self, capabilities: File operations, code editing, terminal access, searchlist, llm):
...
**Reference this template:** `@skill-llm-app-patterns.md`
