---
id: skill-pytorch-fsdp
type: skill
name: pytorch-fsdp
description: Expert guidance for Fully Sharded Data Parallel training with PyTorch
  FSDP - parameter sharding, mixed precision, CPU offloading, FSDP2
...
**Reference this template:** `@skill-pytorch-fsdp.md`
