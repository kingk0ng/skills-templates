...
type: skill
name: memory-search
description: Search conversation history and semantic memory to recall previous discussions,
  decisions, and context. Use when the user asks to "search memory", "what did we
  discuss", "remember when", "find previous conversation", "check history", or before
  starting work to recall prior decisions.
category: ai-maestro
complexity: medium
keywords:
- git
...
**Reference this template:** `@skill-memory-search.md`
