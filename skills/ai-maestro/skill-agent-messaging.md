---
id: skill-agent-messaging
type: skill
name: agent-messaging
description: Send and receive cryptographically signed messages between AI agents
  using the Agent Messaging Protocol (AMP). Use when the user asks to "send a message
  to an agent", "check agent inbox", "message another agent", "reply to a message",
  "notify an agent", or any inter-agent communication task.
category: ai-maestro
complexity: medium
keywords:
- deploy
...
**Reference this template:** `@skill-agent-messaging.md`
