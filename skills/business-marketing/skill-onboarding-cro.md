...
- Design capabilities: File operations, code editing, terminal access, searchCreate first design + export/share
...
**Reference this template:** `@skill-onboarding-cro.md`
