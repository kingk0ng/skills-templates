---
id: skill-marketing-strategy-pmm
type: skill
...
- Existing capabilities: File operations, code editing, terminal access, search[List competitors + complementary products]
...
**Reference this template:** `@skill-marketing-strategy-pmm.md`
