---
id: skill-marketing-demand-acquisition
type: skill
...
- capabilities: File operations, code editing, terminal access, searchAhrefs' Broken Backlinks report
...
Research:
- capabilities: File operations, code editing, terminal access, searchBuiltWith, SimilarWeb, LinkedIn Sales Nav
...
capabilities: File operations, code editing, terminal access, search[HubSpot A/B test, or Google Optimize]
```
...
**Reference this template:** `@skill-marketing-demand-acquisition.md`
