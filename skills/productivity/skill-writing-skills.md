...
- capabilities: File operations, code editing, terminal access, searchActual commands, library names, file types
...
**Reference this template:** `@skill-writing-skills.md`
