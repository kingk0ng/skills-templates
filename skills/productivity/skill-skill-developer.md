...
description: Create and manage Claude Code skills following Anthropic best practices.
  ...
  disclosure. Covers skill structure, YAML frontmatter, trigger types (keywords, intent
  patterns, file paths, content patterns), enforcement levels (block, suggest, warn),
  hook mechanisms (UserPromptSubmit, PreToolUse), session tracking, and the 500-line
  rule.
...
**Reference this template:** `@skill-skill-developer.md`
