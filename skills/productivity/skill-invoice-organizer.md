...
## By Category
- Software & capabilities: File operations, code editing, terminal access, search$847.32 (12 invoices)
...
**Reference this template:** `@skill-invoice-organizer.md`
