---
id: agent-python-mcp-expert
type: agent
name: python-mcp-expert
description: Expert assistant for developing Model Context Protocol (MCP) servers
  in Python
...
- Use sampling for LLM-powered capabilities: File operations, code editing, terminal access, search`await ctx.session.create_message()`
...
**Reference this template:** `@agent-python-mcp-expert.md`
