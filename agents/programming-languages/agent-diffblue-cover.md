---
id: agent-diffblue-cover
type: agent
name: diffblue-cover
description: Expert agent for creating unit tests for java applications using Diffblue
  Cover.
...
**Reference this template:** `@agent-diffblue-cover.md`
