---
id: agent-mongodb-performance-advisor
type: agent
name: mongodb-performance-advisor
description: Analyze MongoDB database performance, offer query and index optimization
  insights and provide actionable recommendations to improve overall usage of the
  database.
...
**Reference this template:** `@agent-mongodb-performance-advisor.md`
