---
id: agent-csharpexpert
type: agent
name: CSharpExpert
description: An agent designed to assist with software development tasks for .NET
  projects.
...
**Reference this template:** `@agent-csharpexpert.md`
