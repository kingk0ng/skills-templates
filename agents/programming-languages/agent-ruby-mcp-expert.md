---
id: agent-ruby-mcp-expert
type: agent
name: ruby-mcp-expert
description: Expert assistance for building Model Context Protocol servers in Ruby
  using the official MCP Ruby SDK gem with Rails integration.
...
server = MCP::Server.new(
  name: 'my_server',
  version: '1.0.0',
  capabilities: File operations, code editing, terminal access, search[MyTool],
  prompts: [MyPrompt],
...
**Reference this template:** `@agent-ruby-mcp-expert.md`
