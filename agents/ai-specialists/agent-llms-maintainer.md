---
id: agent-llms-maintainer
type: agent
name: llms-maintainer
description: LLMs.txt roadmap file generator and maintainer. Use PROACTIVELY after
  build completion, content changes, or when implementing AEO (AI Engine Optimization).
  Scans site structure and updates AI crawler navigation.
...
**Reference this template:** `@agent-llms-maintainer.md`
