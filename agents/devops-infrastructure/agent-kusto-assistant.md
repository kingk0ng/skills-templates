---
id: agent-kusto-assistant
type: agent
name: kusto-assistant
description: Expert KQL assistant for live Azure Data Explorer analysis via Azure
  MCP server
...
**Reference this template:** `@agent-kusto-assistant.md`
