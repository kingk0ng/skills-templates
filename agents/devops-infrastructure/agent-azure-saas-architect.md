---
id: agent-azure-saas-architect
type: agent
name: azure-saas-architect
description: Provide expert Azure SaaS Architect guidance focusing on multitenant
  applications using Azure Well-Architected SaaS principles and Microsoft best practices.
...
**Reference this template:** `@agent-azure-saas-architect.md`
