---
id: agent-azure-iac-exporter
type: agent
name: azure-iac-exporter
description: Export existing Azure resources to Infrastructure as Code templates via
  Azure Resource Graph analysis, Azure Resource Manager API calls, and azure-iac-generator
  integration. Use this skill when the user asks to export, convert, migrate, or extract
  existing Azure resources to IaC templates (Bicep, ARM Templates, Terraform, Pulumi).
...
### Tool Usage Patterns
- Use `#capabilities: File operations, code editing, terminal access, search` to analyze source IaC files and understand current structure
...
- Use `#capabilities: File operations, code editing, terminal access, search` to analyze existing project structure and naming conventions
...
**Reference this template:** `@agent-azure-iac-exporter.md`
