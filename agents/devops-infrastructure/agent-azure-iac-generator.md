---
id: agent-azure-iac-generator
type: agent
name: azure-iac-generator
description: Central hub for generating Infrastructure as Code (Bicep, ARM, Terraform,
  Pulumi) with format-specific validation and best practices. Use this skill when
  the user asks to generate, create, write, or build infrastructure code, deployment
  code, or IaC templates in any format (Bicep, ARM Templates, Terraform, Pulumi).
...
**Reference this template:** `@agent-azure-iac-generator.md`
