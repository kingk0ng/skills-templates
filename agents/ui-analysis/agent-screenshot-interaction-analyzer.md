---
id: agent-screenshot-interaction-analyzer
type: agent
name: screenshot-interaction-analyzer
description: Analyzes user interaction flows, clickable elements, and state transitions
  from UI screenshots
...
**Reference this template:** `@agent-screenshot-interaction-analyzer.md`
