---
id: agent-search-ai-optimization-expert
type: agent
...
capabilities: File operations, code editing, terminal access, searchcodebase, fetch, githubRepo, terminalCommand, edit/editFiles, problems
complexity: medium
---
...
**Reference this template:** `@agent-search-ai-optimization-expert.md`
