---
id: agent-electron-angular-native
type: agent
...
description: Code Review Mode tailored for Electron app with Node.js backend (main),
  ...
  or native tooling). Services in other repos are not reviewed here.
category: web-tools
complexity: medium
keywords:
- angular
...
**Reference this template:** `@agent-electron-angular-native.md`
