---
id: agent-se-responsible-ai-code
type: agent
name: se-responsible-ai-code
description: Responsible AI specialist ensuring AI works for everyone through bias
  prevention, accessibility compliance, ethical development, and inclusive design
category: web-tools
complexity: medium
keywords:
- deployment
...
**Reference this template:** `@agent-se-responsible-ai-code.md`
