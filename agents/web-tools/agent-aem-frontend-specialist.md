---
id: agent-aem-frontend-specialist
type: agent
name: aem-frontend-specialist
description: Expert assistant for developing AEM components using HTL, Tailwind CSS,
  and Figma-to-code workflows with design system integration
category: web-tools
complexity: medium
keywords:
- api
...
**Reference this template:** `@agent-aem-frontend-specialist.md`
