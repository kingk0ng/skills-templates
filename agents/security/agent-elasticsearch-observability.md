---
id: agent-elasticsearch-observability
type: agent
name: elasticsearch-observability
description: Our expert AI assistant for debugging code (O11y), optimizing vector
  search (RAG), and remediating security threats using live Elastic data.
category: security
complexity: medium
keywords:
- api
...
**Reference this template:** `@agent-elasticsearch-observability.md`
