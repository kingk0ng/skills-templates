---
id: agent-stackhawk-security-onboarding
type: agent
name: stackhawk-security-onboarding
description: Automatically set up StackHawk security testing for your repository with
...
**Reference this template:** `@agent-stackhawk-security-onboarding.md`
