---
id: agent-php-mcp-expert
type: agent
name: php-mcp-expert
description: Expert assistant for PHP MCP server development using the official PHP
  SDK with attribute-based discovery
...
**Reference this template:** `@agent-php-mcp-expert.md`
