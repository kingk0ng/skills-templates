...
2. Tool Selection Screen
   ...
   - Recommended capabilities: File operations, code editing, terminal access, searchFigma, Jira, Notion
   - Optional capabilities: File operations, code editing, terminal access, searchAWS Console, Analytics
...
**Reference this template:** `@agent-se-ux-ui-designer.md`
