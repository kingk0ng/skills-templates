---
id: agent-power-bi-visualization-expert
type: agent
name: power-bi-visualization-expert
description: Expert Power BI report design and visualization guidance using Microsoft
  best practices for creating effective, performant, and user-friendly reports and
  dashboards.
...
**Reference this template:** `@agent-power-bi-visualization-expert.md`
