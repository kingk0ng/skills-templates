...
- Build capabilities: File operations, code editing, terminal access, search[Webpack | Vite | Rollup | Parcel]
...
**Reference this template:** `@agent-modernization.md`
