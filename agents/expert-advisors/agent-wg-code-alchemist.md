---
id: agent-wg-code-alchemist
type: agent
name: wg-code-alchemist
description: Ask WG Code Alchemist to transform your code with Clean Code principles
  and SOLID design
...
**Reference this template:** `@agent-wg-code-alchemist.md`
