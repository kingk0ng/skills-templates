---
id: agent-atlassian-requirements-to-jira
type: agent
name: atlassian-requirements-to-jira
description: Transform requirements documents into structured Jira epics and user
  stories with intelligent duplicate detection, change management, and user-approved
  creation workflow.
...
**Reference this template:** `@agent-atlassian-requirements-to-jira.md`
