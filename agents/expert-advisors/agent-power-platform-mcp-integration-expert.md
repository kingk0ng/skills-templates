---
id: agent-power-platform-mcp-integration-expert
type: agent
name: power-platform-mcp-integration-expert
description: Expert in Power Platform custom connector development with MCP integration
  for Copilot Studio - comprehensive knowledge of schemas, protocols, and integration
  patterns
...
**Reference this template:** `@agent-power-platform-mcp-integration-expert.md`
