---
id: agent-pimcore-expert
type: agent
name: pimcore-expert
description: Expert Pimcore development assistant specializing in CMS, DAM, PIM, and
...
**Reference this template:** `@agent-pimcore-expert.md`
