---
id: agent-drupal-expert
type: agent
name: drupal-expert
description: Expert assistant for Drupal development, architecture, and best practices
...
**Reference this template:** `@agent-drupal-expert.md`
