---
id: agent-research-technical-spike
type: agent
...
2. Use multiple capabilities: File operations, code editing, terminal access, search#search #fetch #githubRepo #extensions for initial findings
...
**Reference this template:** `@agent-research-technical-spike.md`
