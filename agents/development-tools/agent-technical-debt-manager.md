---
id: agent-technical-debt-manager
type: agent
name: technical-debt-manager
description: Expert technical debt analyst for code health, maintainability, and strategic
  refactoring planning. Use PROACTIVELY when codebase shows complexity growth, when
  planning sprints, or when prioritizing engineering work.
...
**Reference this template:** `@agent-technical-debt-manager.md`
