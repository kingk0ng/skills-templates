---
id: agent-command-expert
type: agent
name: command-expert
description: CLI command development specialist for the claude-code-templates system.
  Use PROACTIVELY for command design, argument parsing, task automation, and CLI best
...
**Reference this template:** `@agent-command-expert.md`
