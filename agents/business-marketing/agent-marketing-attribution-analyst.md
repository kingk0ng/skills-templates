---
id: agent-marketing-attribution-analyst
type: agent
name: marketing-attribution-analyst
description: Marketing attribution and performance analysis specialist. Use PROACTIVELY
  for campaign tracking, attribution modeling, conversion optimization, ROI analysis,
...
**Reference this template:** `@agent-marketing-attribution-analyst.md`
