---
id: agent-salesforce-expert
type: agent
name: salesforce-expert
description: Provide expert Salesforce Platform guidance, including Apex Enterprise
  Patterns, LWC, integration, and Aura-to-LWC migration.
...
**Reference this template:** `@agent-salesforce-expert.md`
