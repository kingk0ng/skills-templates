...
type: agent
name: arch
description: Expert in modern architecture design patterns, NFR requirements, and
  creating comprehensive architectural diagrams and documentation
...
**Reference this template:** `@agent-arch.md`
