---
id: agent-docusaurus-expert
type: agent
name: docusaurus-expert
description: Docusaurus documentation specialist. Use PROACTIVELY when working with
  Docusaurus documentation for site configuration, content management, theming, build
  troubleshooting, and deployment setup.
...
**Reference this template:** `@agent-docusaurus-expert.md`
