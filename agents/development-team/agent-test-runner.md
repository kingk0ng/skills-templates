...
type: agent
name: test-runner
description: Executes tests, analyzes results, identifies failures, diagnoses root
  causes, and provides actionable fixes for failing tests
...
**Reference this template:** `@agent-test-runner.md`
