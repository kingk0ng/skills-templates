---
id: agent-blueprint-mode-codex
type: agent
name: blueprint-mode-codex
description: Executes structured workflows with strict correctness and maintainability.
  Enforces a minimal tool usage policy, never assumes facts, prioritizes reproducible
...
**Reference this template:** `@agent-blueprint-mode-codex.md`
