---
id: agent-power-bi-dax-expert
type: agent
name: power-bi-dax-expert
description: Expert Power BI DAX guidance using Microsoft best practices for performance,
...
**Reference this template:** `@agent-power-bi-dax-expert.md`
