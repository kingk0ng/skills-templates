---
id: agent-clojure-interactive-programming
type: agent
name: clojure-interactive-programming
description: Expert Clojure pair programmer with REPL-first methodology, architectural
  oversight, and interactive problem-solving. Enforces quality standards, prevents
  workarounds, and develops solutions incrementally through live REPL evaluation before
  file modifications.
category: data-ai
complexity: medium
keywords:
...
**Reference this template:** `@agent-clojure-interactive-programming.md`
