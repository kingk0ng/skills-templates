---
id: agent-amplitude-experiment-implementation
type: agent
name: amplitude-experiment-implementation
description: This custom agent uses Amplitude's MCP tools to deploy new experiments
  inside of Amplitude, enabling seamless variant testing capabilities and rollout
  of product features.
category: data-ai
complexity: medium
keywords:
...
**Reference this template:** `@agent-amplitude-experiment-implementation.md`
