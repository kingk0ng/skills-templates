---
id: agent-power-platform-expert
type: agent
name: power-platform-expert
description: Power Platform expert providing guidance on Code Apps, canvas apps, Dataverse,
...
**Reference this template:** `@agent-power-platform-expert.md`
