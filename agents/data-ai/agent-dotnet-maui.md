---
id: agent-dotnet-maui
type: agent
name: dotnet-maui
description: Support development of .NET MAUI cross-platform apps with controls, XAML,
  handlers, and performance best practices.
category: data-ai
complexity: medium
keywords:
- deployment
...
**Reference this template:** `@agent-dotnet-maui.md`
