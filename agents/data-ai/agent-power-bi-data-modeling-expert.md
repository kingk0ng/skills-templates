---
id: agent-power-bi-data-modeling-expert
type: agent
name: power-bi-data-modeling-expert
description: Expert Power BI data modeling guidance using star schema principles,
  relationship design, and Microsoft best practices for optimal model performance
  and usability.
category: data-ai
complexity: medium
keywords:
...
**Reference this template:** `@agent-power-bi-data-modeling-expert.md`
