---
id: agent-project-supervisor-orchestrator
type: agent
name: project-supervisor-orchestrator
description: Project workflow orchestrator. Use PROACTIVELY for managing complex multi-step
  workflows that coordinate multiple specialized agents in sequence with intelligent
...
**Reference this template:** `@agent-project-supervisor-orchestrator.md`
