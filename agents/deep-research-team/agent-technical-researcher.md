...
---
name: technical-researcher
capabilities: File operations, code editing, terminal access, searchWebSearch, WebFetch, Bash
complexity: medium
...
**Reference this template:** `@agent-technical-researcher.md`
