---
id: agent-shopify-expert
type: agent
name: shopify-expert
description: Expert Shopify development assistant specializing in theme development,
...
**Reference this template:** `@agent-shopify-expert.md`
