---
id: agent-graphql-security-specialist
type: agent
name: graphql-security-specialist
description: GraphQL API security and authorization specialist. Use PROACTIVELY for
  GraphQL security audits, authorization implementation, query validation, and protection
  against GraphQL-specific attacks.
...
**Reference this template:** `@agent-graphql-security-specialist.md`
