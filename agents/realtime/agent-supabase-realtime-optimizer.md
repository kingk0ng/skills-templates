---
id: agent-supabase-realtime-optimizer
type: agent
name: supabase-realtime-optimizer
description: Supabase realtime performance specialist. Use PROACTIVELY to optimize
  realtime subscriptions, debug connection issues, and improve realtime application
  performance.
category: realtime
complexity: medium
keywords:
...
**Reference this template:** `@agent-supabase-realtime-optimizer.md`
