---
id: agent-mcp-security-auditor
type: agent
name: mcp-security-auditor
description: MCP server security specialist. Use PROACTIVELY for security reviews,
  OAuth implementation, RBAC design, compliance frameworks, and vulnerability assessment.
...
**Reference this template:** `@agent-mcp-security-auditor.md`
