---
id: agent-mcp-registry-navigator
type: agent
name: mcp-registry-navigator
description: MCP registry discovery and integration specialist. Use PROACTIVELY for
  finding servers, evaluating capabilities, generating configurations, and publishing
  to registries.
...
**Reference this template:** `@agent-mcp-registry-navigator.md`
