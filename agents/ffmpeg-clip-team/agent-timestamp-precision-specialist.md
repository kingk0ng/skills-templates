---
id: agent-timestamp-precision-specialist
type: agent
name: timestamp-precision-specialist
description: Frame-accurate timestamp extraction specialist. Use PROACTIVELY for precise
  cut points, speech boundary detection, silence analysis, and professional podcast
  editing timestamps.
...
**Reference this template:** `@agent-timestamp-precision-specialist.md`
