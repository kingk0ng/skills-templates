---
id: agent-social-media-clip-creator
type: agent
name: social-media-clip-creator
description: Social media video clip optimization specialist. Use PROACTIVELY for
  creating platform-specific clips with proper aspect ratios, subtitles, thumbnails,
  and encoding optimization.
...
**Reference this template:** `@agent-social-media-clip-creator.md`
