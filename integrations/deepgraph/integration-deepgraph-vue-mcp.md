---
id: integration-deepgraph-vue-mcp
type: integration
name: DeepGraph Vue MCP
description: Analyze Vue.js applications including component composition, reactive
  data flow, and template-script relationships.
category: deepgraph
complexity: medium
keywords: []
capabilities: []
...
**Reference this template:** `@integration-deepgraph-vue-mcp.md`
