---
id: integration-deepgraph-nextjs-mcp
type: integration
name: DeepGraph Next.js MCP
description: Deep code analysis and visualization for Next.js projects. Understand
  component relationships, dependencies, and architecture patterns.
category: deepgraph
complexity: medium
keywords: []
capabilities: []
...
# DeepGraph Next.js MCP Integration
...
**Reference this template:** `@integration-deepgraph-nextjs-mcp.md`
