...
type: integration
name: memory
description: Persistent memory and context management for Claude Code sessions. Store
  and recall information across conversations and projects.
...
**Reference this template:** `@integration-memory.md`
